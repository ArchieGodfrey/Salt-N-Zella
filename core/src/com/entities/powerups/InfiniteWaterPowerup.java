...
public class InfiniteWaterPowerup extends PowerupSprite {

    private int activeTime = 600; //10 seconds

    public InfiniteWaterPowerup(ArrayList<Texture> textureSlices, float x, float y) {
        super(textureSlices, x, y);
    }

    public void action(Firetruck activeFireTruck){
        activeFireTruck.setPowerup(activeTime, "infiniteWater");
    }
}
